...
#unfiltered
t_data, y_data = np.loadtxt(f"Data\\Waveform_Data\\{wavetype}\\Unfiltered\\WFM13.CSV", delimiter=",", skiprows=1, unpack=True) #runs all files (comment out as you see fit)
